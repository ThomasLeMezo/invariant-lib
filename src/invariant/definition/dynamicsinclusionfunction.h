...
public:   
     ...
     * @param taylor
     */
    DynamicsInclusionFunction(const std::vector<ibex::Function *> functions, ibex::IntervalVector inclusion_parameter, const DYNAMICS_SENS sens=FWD, bool taylor=false);
     ...
     * @param taylor
     */
    DynamicsInclusionFunction(ibex::Function *f, ibex::IntervalVector inclusion_parameter,  const DYNAMICS_SENS sens=FWD, bool taylor=false);
     ...
     * @param parameter
     */
    void set_inclusion_parameter(ibex::IntervalVector parameter);
