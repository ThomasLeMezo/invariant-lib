...
EulerianMaze<_Tp>::~EulerianMaze(){
    ...
    for(Dynamics_Function* dyn:m_dyn_array)
        delete(dyn);
...
void EulerianMaze<_Tp>::init_mazes(const ibex::IntervalVector &space, ibex::Function *f_dyn){
    ...
    // Dynamics
    m_dyn_array[0] = new Dynamics_Function(f_dyn, FWD);
    m_dyn_array[1] = new Dynamics_Function(f_dyn, BWD);
    ...
    for(size_t i=0; i<nb_sep; i++){
        ...
        if(i<nb_sep-1){
            ...
            invariant::Maze<_Tp> *maze_outer_fwd = new invariant::Maze<_Tp>(dom_outer, m_dyn_array[0]);
            ...
            invariant::Maze<_Tp> *maze_inner_fwd = new invariant::Maze<_Tp>(dom_inner, m_dyn_array[0]);
        ...
        if(i>0){
            ...
            invariant::Maze<_Tp> *maze_outer_bwd = new invariant::Maze<_Tp>(dom_outer, m_dyn_array[1]);
            ...
            invariant::Maze<_Tp> *maze_inner_bwd = new invariant::Maze<_Tp>(dom_inner, m_dyn_array[1]);
