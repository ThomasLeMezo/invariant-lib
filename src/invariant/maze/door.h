...
public:
     ...
     * @param zeros
     */
    void push_back_zeros_in_vector_field(std::vector<int> zeros);
     ...
     * @return
     */
    const std::vector<int>& get_where_zeros(size_t vector_field_id) const;
...
protected:
    ...
    std::vector<std::vector<int>> m_zeros_in_vector_fields;
};
}
...
inline void Door::push_back_zeros_in_vector_field(std::vector<int> zeros){
    m_zeros_in_vector_fields.push_back(zeros);
}

inline const std::vector<int>& Door::get_where_zeros(size_t vector_field_id) const{
