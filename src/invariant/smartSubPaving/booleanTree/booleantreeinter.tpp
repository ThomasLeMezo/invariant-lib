...
bool BooleanTreeInter<_TpR,_TpF,_TpD>::eval_bisection(Pave<_TpR,_TpF,_TpD> *pave)
{
    bool result = true;
...
template<typename _TpR,typename _TpF,typename _TpD>
bool BooleanTreeInter<_TpR,_TpF,_TpD>::eval_set_empty(Pave<_TpR,_TpF,_TpD> *pave)
{
    bool result = true;
    for(Maze<_TpR,_TpF,_TpD>* maze:this->m_maze_list){
        Room<_TpR,_TpF,_TpD>* r = pave->get_rooms()[maze];
