...
public:
    ...
    BooleanTreeInter(const std::vector<BooleanTree<_Tp>*> &bisectionTree_list):BooleanTree<_Tp>(bisectionTree_list){}
    ...
    BooleanTreeInter(const std::vector<Maze<_Tp>*> &maze_list, const std::vector<BooleanTree<_Tp>*> &bisectionTree_list):BooleanTree<_Tp>(maze_list, bisectionTree_list){}
