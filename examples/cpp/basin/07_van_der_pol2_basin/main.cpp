...
int main(int argc, char *argv[])
{
    ...
    vibes::beginDrawing();
    VibesMaze v_maze("Van Der Pol Basin 2", &maze_outer, &maze_inner);
...
//    v_maze.drawCircle(x1_c, x2_c, r, "black[red]");
    ...
    vibes::saveImage("/home/lemezoth/workspaceQT/tikz-adapter/tikz/figs/svg/van_der_pol2_basin.svg", "Van Der Pol Basin 2");
    vibes::endDrawing();
